...
parser = argparse.ArgumentParser(
    description="ReAct evaluation for Intercode environment"
)
...
class ExperimentWrapper:
    ...
    def run_expr(self):
        try:
            for idx in tqdm(
                range(len(self.env.data_loader)), disable=self.args.verbose
            ):
